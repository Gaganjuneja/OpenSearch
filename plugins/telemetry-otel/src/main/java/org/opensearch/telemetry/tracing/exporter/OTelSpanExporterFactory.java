...
public class OTelSpanExporterFactory {
    ...
    public static SpanExporter create(Settings settings) {
        ...
        SpanExporter spanExporter = instantiateExporter(spanExporterProviderClass);
        logger.info("Successfully instantiated the SpanExporter class {}", spanExporterProviderClass);
        return spanExporter;
    }

    private static SpanExporter instantiateExporter(Class<SpanExporter> exporterProviderClass) {
        try {
